...
<body>
    ...
    <h3>🌹Le deseo lo mejor en su día, sublime y valiosa mujer. Mi querida y estimada Damaris. Quiero deserarte un excelente dia lleno de bendiciones.🌹</h3>
    <h3>🌹Eres una mujer maravillosa y admirable, le agradezco a Dios por tu vida y su existencia, no hay mujer que logre compararse contigo, eres unica entre los casi 8000 millones de habitantes del mundo🌹
    ...
    <div id="❤" class="letter-content">
        ...
        <div style="display: flex; justify-content: center; align-items: center;">
            ...
            <div style="margin: 20px;">
                ...
                <p>💖D - Dulce y siempre atenta💖</p>
                <p>💖A - Amable y generosa en su trato💖</p>
                <p>💖M - Magnífica en todo lo que hace💖</p>
                <p>💖A - Admirable por su fortaleza💖</p>
                <p>💖R - Radiante, llenando de luz cada espacio💖</p>
                <p>💖I - Inspiradora en cada momento💖</p>
                <p>💖S - Sabia y llena de conocimientos💖</p> 
            </div>
        </div>
